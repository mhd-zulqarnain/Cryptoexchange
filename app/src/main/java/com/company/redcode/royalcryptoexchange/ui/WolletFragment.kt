...
import com.company.redcode.royalcryptoexchange.adapter.WolletAdopter
import com.company.redcode.royalcryptoexchange.models.Wallet

class WolletFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var view: View = inflater.inflate(R.layout.fragment_wallet1, container, false)
        initView(view)
        return view
    ...
    var wollet = arrayListOf<Wallet>()
        ...
        var adopter = WolletAdopter(wollet)
