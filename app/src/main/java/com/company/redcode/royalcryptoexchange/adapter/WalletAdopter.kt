...
import kotlinx.android.synthetic.main.dialogue_wollet_send.view.*

class WalletAdopter (var datalist: ArrayList<Wallet>):
        RecyclerView.Adapter<WalletAdopter.ViewHolder>() {
